...
export default function LoginPage() {
  ...
  const inputBase: React.CSSProperties = {
    ...
    borderRadius: 11,
    color: '#f0f0f0', fontSize: '0.92rem', fontFamily: 'inherit',
        ...
        <div style={{
          ...
          <div style={{
            ...
            {bootLines > 0 && !bootDone && (
              <div style={{
                width: 8, height: 14, background: '#f0f0f0',
      ...
      <div className="login-outer">
        <div className="login-layout">
          ...
          <div style={{ marginBottom: 36 }}>
            <div style={{ position: 'relative', display: 'inline-block', marginBottom: 20 }}>
              <img src="/logo.jpg" alt="Hitech" style={{
                ...
                borderRadius: 20,
                display: 'block',
                boxShadow: '0 0 0 2px rgba(0,0,0,0.12), 0 16px 48px rgba(0,0,0,0.15)',
              }} />
            </div>
            <div style={{
            ...
            <div style={{
              fontFamily: 'var(--font-mono)', fontSize: '0.63rem',
              letterSpacing: '0.13em', color: '#d0d0d0',
          ...
          <div
            key={errorKey}
            style={{
              background: 'linear-gradient(160deg, #4e4e4e 0%, #141414 100%)',
              border: `1px solid ${cardFocused ? 'rgba(255,255,255,0.22)' : 'rgba(255,255,255,0.10)'}`,
              borderRadius: 18, padding: '24px 20px 22px',
              boxShadow: cardFocused
                ? '0 20px 56px rgba(0,0,0,0.7), 0 4px 16px rgba(0,0,0,0.4)'
            ...
            <div className="login-mobile-logo" style={{ textAlign: 'center', marginBottom: 18 }}>
              <div style={{ position: 'relative', display: 'inline-block' }}>
                <img src="/logo.jpg" alt="Hitech" style={{
                  ...
                  boxShadow: '0 0 0 2px rgba(0,0,0,0.1), 0 8px 28px rgba(0,0,0,0.1)',
                  display: 'block',
                }} />
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              <div>
                <label style={{
                  ...
                  letterSpacing: '0.11em', color: '#888888',
                  ...
                  {unlocked && (
                    <button
                      ...
                      style={{
                        ...
                        cursor: 'pointer', color: showPassword ? '#f0f0f0' : '#555555',
                    ...
                    <button
                      ...
                      style={{
                        ...
                        background: role === value
                          ...
                          : '#4e4e4e',
                        color: role === value ? '#f0f0f0' : '#c0b8b0',
          ...
          <div style={{
            ...
            <div style={{ textAlign: 'center', marginBottom: 14 }}>
              <span style={{ fontFamily: 'var(--font-mono)', color: '#888888', fontSize: '0.82rem' }}>
                No account?{' '}
              </span>
              <a href="/signup" style={{
                fontFamily: 'var(--font-mono)', fontSize: '0.82rem',
                color: '#f0f0f0', textDecoration: 'underline', fontWeight: 700,
                letterSpacing: '0.04em',
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <p style={{
                fontFamily: 'var(--font-mono)', color: '#d0d0d0', fontSize: '0.6rem',
